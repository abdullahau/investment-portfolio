...
home_investment_schedule["Cumulative Interest"] = home_investment_schedule["Interest Portion"].cumsum()
home_investment_schedule["Principal Paid"] = home_investment_schedule["Principal Portion"].cumsum()

show(home_investment_schedule)
```
